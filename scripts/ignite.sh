...
curl "https://fuse-ignite.$igniteDomain/api/v1/connections" -H "Origin: https://fuse-ignite.$igniteDomain" -H 'Accept-Encoding: gzip, deflate, br' -H 'Accept-Language: en-US,en;q=0.9,es;q=0.8,pt-BR;q=0.7,pt;q=0.6' -H 'Accept: application/json, text/plain, */*' -H "Referer: https://fuse-ignite.$igniteDomain/connections/create/review" -H 'Connection: keep-alive' -H 'SYNDESIS-XSRF-TOKEN: awesome' -H 'DNT: 1' --data-binary '{"connector":{"description":"DataShape Connector for Syndesis","icon":"extension:icon.png","actionsSummary":{"totalActions":1},"uses":0,"id":"ext-io-syndesis-extensions-syndesis-connector-datashape","version":1,"actions":[{"id":"io.syndesis:datashape-action","name":"DataShape Endpoint","description":"DataShape Endpoint","descriptor":{"componentScheme":"mock","inputDataShape":{"kind":"none"},"outputDataShape":{"kind":"any"}},"actionType":"connector","pattern":"To"}],"name":"DataShape Connector","dependencies":[{"type":"EXTENSION","id":"io.syndesis.extensions:syndesis-connector-datashape"}],"properties":{}},"icon":"extension:icon.png","connectorId":"ext-io-syndesis-extensions-syndesis-connector-datashape","name":"DataShape","description":null}' --compressed --insecure -b cookies.txt -s
